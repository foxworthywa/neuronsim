...
`docs/worksheet/` holds a two-page group worksheet keyed to the scenes (with an instructor key
on page 3): `MuscleSim-worksheet.docx` / `.pdf`, generated by `node docs/worksheet/make-worksheet.js`.
