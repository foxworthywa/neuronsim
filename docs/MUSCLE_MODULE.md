...
| 14 | Grading force (optional) | whole muscle with three motor units of different size; force gauge | reads the one-line motor-unit intro; recruits units; raises rate | what differs between a gentle and a strong pull | three units recruited and rate raised → Lab |
