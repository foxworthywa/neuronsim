...
(function () {
  ...
  const profile = {
    ...
    traceTitle: (comp) => `Membrane potential recorded inside the fibre (${comp === 'endplate' ? 'end plate' : comp === 'R3' ? '5 mm from the end plate' : comp === 'R8' || comp === 'L8' ? 'far end' : comp === 'nerve' ? 'motor terminal' : comp})`,
    ...
    scenes.push((function () {
      ...
      return {
        ...
        steps: [
          ...
          {
            view: 'membrane', viewOpts: { comp: 'R3', inset: 'R3', channels: ['Na_v', 'K_v', 'Na_v', 'K_v', 'K_leak'], caption: 'The sarcolemma 5 mm from the electrodes. New channels, marked V.' }, remount: true, record: 'R3', extra: ['R8'], electrode: true,
